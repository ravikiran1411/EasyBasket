  ...
  return (
    <div className="p-4 sm:mx-5 flex flex-col md:flex-row md:gap-8">
      ...
      <div className="sm:min-w-1/4 h-fit sm:sticky sm:top-20 ">
        <p
          className="text-xl my-3 flex items-center gap-2  "
        ...
        <div
          className={`sm:px-10 w-full rounded-md border border-slate-300 bg-slate-100 sm:block pl-5 py-5 mt-6 ${showFilter ? "" : "hidden"} `}
        >
        ...
        <div className="hidden sm:block flex-col gap-4 mt-6 bg-gradient-to-r from-green-100 to-green-50 border border-green-300 rounded-xl p-4 cursor-pointer hover:shadow-md transition">
          <div className="flex gap-5">
            <div>
              <p className="text-[10px] font-semibold text-green-700 bg-green-200 w-fit px-2 py-0.5 rounded-full mb-2">
                LIMITED OFFER
              </p>
              <p className="text-sm font-semibold text-gray-800 leading-tight">
                15 min delivery on combos
              </p>
              <p className="text-xs text-gray-600 mt-1">
                Save more on combo packs{" "}
              </p>
            </div>
          ...
          <button
            onClick={() => navigate("/product?category=combo")}
            className="mt-2 bg-green-600 text-white text-sm px-3 py-1.5 rounded-lg hover:bg-green-700 transition"
          >
            Shop Now
          </button>
        </div>
        ...
        <div className="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            ...
            <select
              ...
              className="w-full sm:w-45 border border-gray-200 bg-white px-3 py-2 rounded-lg text-sm outline-none shadow-sm hover:border-green-500 focus:border-green-500 transition cursor-pointer"
            >
